...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function updateFaceTelemetry() {
    ...
    faPose.textContent = `Y: ${(face.pose?.yaw || 0).toFixed(1)}° P: ${(face.pose?.pitch || 0).toFixed(1)}°`;
    faSharpness.textContent = (q.sharpness || 0.88).toFixed(2);
    faExposure.textContent = (q.exposure || 0.91).toFixed(2);
